...
Indie Python is a personal project by @KennedyRichard that aims to publish and manage independent Python open-source apps and games to promote fun and learning.
